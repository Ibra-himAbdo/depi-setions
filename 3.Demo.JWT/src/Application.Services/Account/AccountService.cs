...
internal class AccountService : IAccountService
{
    ...
    public AccountService(UserManager<ApplicationUser> userManager, IEmailService emailService, IConfiguration configuration, ITokenService tokenService, IEmailTemplateService templateService)
    {
